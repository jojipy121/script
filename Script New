...
local function DYFL_fake_script() -- ScreenGui.Gui Close  
	local script = Instance.new('LocalScript', ScreenGui)

	local button = script.Parent.Frame.DragFrame.Close
	button.MouseButton1Click:Connect(function()
		script.Parent.Frame.DragFrame = false
		script.Parent.Parent.Open.Visible = true
	end)
end
coroutine.wrap(DYFL_fake_script)()
local function ETJR_fake_script() -- ScreenGui.Gui Open 
	local script = Instance.new('LocalScript', ScreenGui)
...
coroutine.wrap(ETJR_fake_script)()
local function OSGIUOY_fake_script() -- DragFrame.Execute 
...
coroutine.wrap(OSGIUOY_fake_script)()
local function BCSSQF_fake_script() -- DragFrame.Clear 
	local script = Instance.new('LocalScript', DragFrame)
...
coroutine.wrap(BCSSQF_fake_script)()
local function XLLY_fake_script() -- DragFrame.Dragging 
	local script = Instance.new('LocalScript', DragFrame)
...
coroutine.wrap(XLLY_fake_script)()
